...
def test_is_valid_booking_full_comp():
...
def test_is_valid_booking_purchase_more_than_available_places():
    status, message = server_utils.is_valid_booking(
...
def test_is_valid_booking_valid_data():
